...
describe('EffectFactory', () => {
  it('should register and create SingleTargetDamage effect', () => {
    ...
    const effect = EffectFactory.createEffect("SingleTargetDamage", 10);
  ...
  it('should register and create SingleTargetHeal effect', () => {
    ...
    const effect = EffectFactory.createEffect("SingleTargetHeal", 10);
  ...
  it('should register and create SingleTargetShield effect', () => {
    ...
    const effect = EffectFactory.createEffect("SingleTargetShield", 10);
  ...
  it('should unregister an effect', () => {
    ...
    expect(() => EffectFactory.createEffect("SingleTargetDamage", 10)).toThrow();
  });
});
