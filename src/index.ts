export * from "./factories/EffectFactory";
...
export * from "./strategies/SingleTargetDamage";
export * from "./strategies/SingleTargetHeal";
export * from "./strategies/SingleTargetshield";
export * from "./strategies/TargetType.type";


export * from "./types/Die.type";
export * from "./types/Face.type";
export * from "./types/Player.type";
export * from "./types/DieFace.type";
export * from "./types/GameState.type";
...
export * from "./types/Modifier.type";